...
PowerUp4::PowerUp4(Texture * texture, Vector2 position, int colWidth, int colHeight, int speed)
{
...
void PowerUp4::AddPlayerForce(Vector2 force)
{
...
void PowerUp4::ReducePlayerForce(Vector2 force)
{
...
void PowerUp4::Draw(SDL_Renderer * renderer)
{
...
void PowerUp4::Update(float deltaTime)
{
